...
public class SignupOne extends JFrame implements ActionListener{
    long random;
    JTextField nameTextField,fTextField,dobTextField,emailTextField,pinTextField,cityTextField,stateTextField,addressTextField;
    JButton next;
    ...
    SignupOne(){
        ...
        JLabel personalDetails=new JLabel("Page1: personalDetails");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                ...
                Conn c=new Conn();
                String query="insert into sign(formno,name,father_name,dob,gender,email,marital_status,address,city,state,pin) value('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+state+"','"+pin+"')";
